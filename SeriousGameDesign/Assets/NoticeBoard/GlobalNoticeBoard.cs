...
{
    public static GlobalNoticeBoard Instance;
    ...
    public class EventList
    {
        ...
        public GlobalEvent m_eventType;
    }
    ...
    void Awake()
    {
        ...
        else
        {
            ...
            {
                for (int i = 0; i <= (int)GlobalEvent.Count - 1; i++)
                {
                    EventList tempList = new EventList();
                    tempList.m_eventType = (GlobalEvent)i;
    ...
    public void AddDelayEvent(GlobalEvent _event, object _data = null)
    {
    ...
    public void AddRapidEvent(GlobalEvent _event, object _data = null)
    {
    ...
    public void SubscribeToEvent(GlobalEvent _event, EventTrigger _trigger)
    {
    ...
    public void UnsubscribeToEvent(GlobalEvent _event, EventTrigger _trigger)
    {
        EventList tempList = m_eventList[(int)_event];
        tempList.m_eventTrigger -= _trigger;
        m_eventList[(int)_event] = tempList;
